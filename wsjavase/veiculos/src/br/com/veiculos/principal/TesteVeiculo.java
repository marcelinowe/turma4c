...
public class TesteVeiculo {
	...
	public static void main(String[] args) {
		...
		if(JOptionPane.showConfirmDialog(null,"Deseja acelerar o carro?","Pergunta",JOptionPane.YES_NO_OPTION,JOptionPane.QUESTION_MESSAGE)==0){
			do {
				if(JOptionPane.showConfirmDialog(null,"Acelerar com velocidade padrão? 10km/h em 10km/h","Pergunta",JOptionPane.YES_NO_OPTION,JOptionPane.QUESTION_MESSAGE)==0) {
					carro.acelerar();
				}
				else
				{
		...
		if(carro.getStatus() == true) {
			System.out.println("O carro está em movimento............? Sim - "+carro.getVelocidadeAtual()+" KM/H");
		}
		else{
			System.out.println("O carro está em movimento............? Não");
		}
